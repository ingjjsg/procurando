 ...
 */
  ...
  function editar_persona(lngcodigo)
  {
    if (lngcodigo!='')
      location.href='vista_ingresoPersona.php?id='+lngcodigo;
    else
      alert('Persona no esta Registrada');
  }

  function busca_persona_nueva_ayuda(lngcodigo)
  {
    if (lngcodigo!='')
      location.href='vista_ingresoAyuda.php?id='+lngcodigo;
    else
      alert('Persona no esta Registrada');
  }
  ...
  function eliminarAyuda(id_persona,lngcodigo){
        xajax_eliminarAyuda(id_persona,lngcodigo);
}
  function filtrar(){
...
//         cargar(id_persona)
    ...
    function buscarP(nacionalidad,id_persona)
    {
         xajax_buscarP(nacionalidad,id_persona);
//         cargar(id_persona)
    }
