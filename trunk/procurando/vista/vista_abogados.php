    ...
    <body onload="xajax_buscarDatosAbogados()" >
        ...
        <center>
            <form name="frmabogados" id="frmabogados" method="post">
                ...
                <tr>
                    <td width="65%" class="menu_izq_titulo">Abogados</td>
                    <td width="10%" align="center" class="menu_izq_titulo">
                        ...
                        <img src="../comunes/images/user_add.png" onmouseover="Tip('Nuevo Abogado')" onmouseout="UnTip()" onclick="location.href='vista_nuevo_abogado.php'"/>
                        &nbsp;&nbsp;&nbsp;
                        <?php }?>
