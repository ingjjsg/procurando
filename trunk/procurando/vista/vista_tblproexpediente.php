<?php
    ...
    $xajax->registerFunction('Resetear_busqueda');    
            ...
            <form name="frmexpedientes" id="frmexpedientes" method="post">
                ...
                <tr>
                    ...
                    <td width="10%" align="center" class="menu_izq_titulo">
                        ...
                        &nbsp;&nbsp;&nbsp;
                        <?php }?>
                        <img src="../comunes/images/filter.png" onmouseover="Tip('Filtros')" onmouseout="UnTip()" border="0" onclick="verForm('formulario');xajax_Resetear_busqueda();"/>
                        &nbsp;&nbsp;&nbsp;                        
