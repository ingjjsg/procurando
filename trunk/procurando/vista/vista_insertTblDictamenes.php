                                ...
                                <table width="100%" border="0" class="tablaVer" >
                                   ...
                                   <tr>
                                    ...
                                    <tr>
                                        <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                            <div align="center" style="background-image: url('../comunes/images/barra.png')">
                                                <strong>Documentos del Dictamen</strong>
                                            </div>
                                        </td>
                                    </tr>      
                                    <tr>
                                        <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                            ...
                                            if ($id_dictamen)
                                            {
                                                $scr="../vista/vista_uploadDictamen.php?id=".$id_dictamen; ?>
                                                <iframe  width="100%" scrolling="auto" height="200" frameborder="0" src="<?php echo $scr; ?>" scrolling="auto" frameborder="0" width="100%" height="600"></iframe>
                                                <?php } ?>
                                            </div>  
                                        </td>
                                    </tr>                                       
                                    <tr>
                                        <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                            <div align="center" style="background-image: url('../comunes/images/barra.png')">
                                                <strong>Resumen del Dictamen</strong>
                                            </div>
                                        </td>
                                    </tr>      
                                    <tr>
