<?php
    ...
    require_once '../controlador/reporteDocumentoControlador.php';
    require_once ('../comunes/xajax/xajax_core/xajax.inc.php');
        
    
    $xajax= new xajax();
 
     $xajax->registerFunction('selectDocumentoReporte');         
    ...
    <body onload="cargar()" >
        ...
        <center>
            ...
            <fieldset style="border:#339933 2px solid">                
                ...
                <tr>
                    <td width="65%" class="menu_izq_titulo">Reporte de Documento</td>
                        ...
                        <table width="100%">
                            <tbody><tr>
                                ...
                                <td align="center" width="35%">
                                    <img onclick="xajax_selectDocumentoReporte(xajax.getFormValues('frmDocumento'),'pdf');" onmouseout="UnTip()" onmouseover="Tip('Exportar a PDF')" src="../comunes/images/botonpdf.png">
                                ...
                                <td align="center" width="35%">
                                    <img onclick="xajax_selectDocumentoReporte(xajax.getFormValues('frmDocumento'),'ods');" onmouseout="UnTip()" onmouseover="Tip('Exportar a OpenOffice')" src="../comunes/images/botonoo.png">
                                </td>
                                <td width="15%">&nbsp;</td>
                            </tr>
                        </tbody></table>
