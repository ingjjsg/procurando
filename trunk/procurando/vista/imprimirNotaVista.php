<?php
    ...
    $pdf->MultiCell(0, 4, "Para: ".utf8_decode($strPR), 0, 1, 'L');
    $pdf->Ln(5);
    $pdf->MultiCell(0, 4, "De: ".utf8_decode($dataGerente[0]['nombre_dpto']), 0, 1, 'L');
    $pdf->Ln(5);
    ...
    $pdf->Cell(33, 5, "", 0, 0, 'L');
    $pdf->Cell(65, 5, "Entregado por:", 'LTR', 0, 'L');
    $pdf->Cell(65, 5, "Recibido por:", 'LTR', 0, 'L');
    $pdf->Cell(30, 5, "", 0, 0, 'L');
    $pdf->Ln();
    $pdf->Cell(33, 5, "", 0, 0, 'L');
    ...
    $pdf->Ln();
    $pdf->Cell(33, 5, "", 0, 0, 'L');
    $pdf->Cell(65, 5, $dataGerente[0]['strnombre']." ".$dataGerente[0]['strapellido'], 'LR', 0, 'C');
    $pdf->Cell(65, 5, "", 'LR', 0, 'L');
    $pdf->Cell(30, 5, "", 0, 0, 'L');
    $pdf->Ln();
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(33, 5, "", 0, 0, 'L');
    $pdf->Cell(65, 5, $dataGerente[0]['nombre_cargo'], 'LR', 0, 'C');
    $pdf->Cell(65, 5, utf8_decode($strPR), 'LR', 0, 'L');
    $pdf->Cell(30, 5, "", 0, 0, 'L');
    $pdf->Ln();
    $pdf->SetFont('Arial', '', 6);
    $pdf->Cell(33, 5, "", 0, 0, 'L');
    $pdf->Cell(65, 5, utf8_decode($dataGerente[0]['nombre_dpto']), 'LBR', 0, 'C');
