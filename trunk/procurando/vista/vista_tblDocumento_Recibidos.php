...
//    require_once "../controlador/tblproexpedienteControlador.php";    
    ...
    $xajax= new xajax();
    $xajax->registerFunction('selectAllDocumentoRecibidos');
    ...
    $xajax->registerFunction('ActualizarItemDocumentoRecibidos');    
...
//                cargar(1);
            ...
            function filtrar(){
                ...
                xajax_selectAllDocumentoRecibidos(id_tipo, id_evento, id_unidad, id_prioridad);                        
                ver('formulario');
            }
        </script>
    </head>
    <body onload="xajax_selectAllDocumentoRecibidos();xajax_llenarSelectTipoDocumento('','',1);xajax_llenarSelectTipoEvento();xajax_selectAllDpto();xajax_llenarSelectTipoPrioridad();">
        <form name="frmDocumento" id="frmDocumento" method="post" style="">
            <script src="../comunes/js/wz_tooltip/wz_tooltip.js" type="text/javascript"></script>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="65%" class="menu_izq_titulo">Remisión de Documentos Recibidos<div id='capaMaestro'></div></td>
