...
<div class="contenedor_general">
 ...
 // include('../comunes/php/utilidades.php');
  ...
  <div class="desarrollo" id="largo">
    <div class="desarrollo_contenido"><iframe  id="contenido" name="contenido" src="../vista/vista_tblagenda.php" scrolling="auto" frameborder="0" width="100%" height="600"></iframe></div>
  </div>
  <!-- derecha -->
</div>
