                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:10px; padding-bottom:0px;">
                            ...
                            <div align="left">
                                <ul id="countrytabs" class="shadetabs">
                                    <li><a id="link1" href="#" rel="country1"  class="selected">Datos</a></li> 
                                    <li><a id="link2" href="#" rel="country2">Ingreso</a></li> 
                                    <li><a id="link3" href="#" rel="country3">Cita Medica</a></li>                                     
                                    <li><a id="link4" href="#" rel="country4">Farmacia</a></li>                                        
                                    <li><a id="link5" href="#" rel="country5">Situaciónes</a></li>
                                    <li><a id="link6" href="#" rel="country6">Documentos</a></li>                        
                                    <li><a id="link7" href="#" rel="country7">Fase</a></li>    
                                    <li><a id="link8" href="#" rel="country8">Actuaciones</a></li>                                                            
                                    <li><a id="link9" href="#" rel="country9" style="display:none">Divorcio/Sep</a></li>                                        
                                </ul>
                                    ...
                                    <div id="country1"  class="tabcontent" style="height:100%; overflow-y:auto">
                                        <table width="100%" border="0" class="tablaTitulo" >
                                            ...
                                            <tr>
                                                <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                                    <div align="left" style="background-image: url('../comunes/images/barra.png')">
                                                        <strong>REPRESENTANTE DE ASOCIACIÓN ESTUDIANTIL</strong>
                                                    </div>
                                                </td>
                                            </tr>          
                                            <tr>
                                                ...
                                                <tr>
                                                    <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                                        <div align="center" style="background-image: url('../comunes/images/barra.png')">
                                                            <strong>Descripción del Ingreso del Estudiante</strong>
                                                        </div>
                                                    </td>
                                                </tr>                                                
                                                <tr>
...
<!--                                                        <img id="delete" name="delete" src="../comunes/images/page_delete.png" onmouseover="Tip('Eliminar Honorario')" onmouseout="UnTip()" border="0" onclick="if (confirm('¿Seguro desea eliminar el Honorario?'))xajax_eliminarHonorario(xajax.getFormValues('frminserthonorarios'));"/>                            
                                    ...
                                    <div id="country5" class="tabcontent" style="height:90%; overflow-y:auto">
                                            <table width="100%" border="0" class="tablaTitulo" >
                                                <tr>
                                                    <td colspan="6" bgcolor="#F8F8F8" >
                                                        <div align="right">
