...
//    require_once "../controlador/tblproexpedienteControlador.php";    
    ...
    $xajax= new xajax();
    $xajax->registerFunction('selectAllAgendaAnexadas');
    ...
    $xajax->registerFunction('ActualizarItemAgendaAnexadas');    
...
//                cargar(1);
            ...
            function filtrar(){
                ...
                xajax_selectAllAgendaAnexadas(id_tipo, id_evento, id_unidad, id_prioridad, id_integrantes_unidad, id_expediente);                                        
                ver('formulario');
            }
        </script>
    </head>
    <body onload="xajax_selectAllAgendaAnexadas();xajax_llenarSelectTipoAgenda('','',1);xajax_llenarSelectTipoEvento();xajax_selectAllDpto();xajax_llenarSelectTipoPrioridad();">
