...
<!--                            <input type="text" id="id_proactuacion" name="id_proactuacion" value="<?php echo $lngcodigo_expediente ?>" />-->
                        ...
                        <!--                                                    <img src="../comunes/images/ico_18_127.gif" onmouseover="Tip('Buscar Abogado Responsable')" onmouseout="UnTip()" border="0" onclick="xajax_buscarAbogado(document.frminscribir.cedula_abogado_responsable.value,'responsable');"/>                                    -->
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                                                            <div align="left" style="background-image: url('../comunes/images/barra.png')">
                                                                                <strong>ABOGADOS EJECUTORES</strong>
                                                                                <img src="../comunes/images/user_suit_add.png" onmouseover="Tip('Nuevo Abogado')" onmouseout="UnTip()" border="0" onclick="javascript:$('contenedorAbogados').hide();$('id_tr_abogados_ejecutores').toggle();$('contenedorAbogadosEjecutorExpediente').toggle();"/>
                                                                            </div>
                                                                        </td>
                                                                    </tr>                   
                                                                    ...
                                                                    <tr id="id_tr_abogados_ejecutores" style="display:none;">
                                                                        <td width="20%">
                                                                            C.I. Abogados Ejecutores:
                                                                        </td>
                                                                        <td width="30%">
                                                                        ...
                                                                        <td width="30%">
                                                                            ...
                                                                            <input type="images" onmouseover="Tip('Ingresar Abogado Demandantes')" style="background-color:#B9D5E3;border:1px outset #B9D5E3;color:#004E7D;cursor:pointer;margin:1px;padding:1px; width:55px; font-size:11px;" onclick="xajax_IngresarAbogadoEjecutorExpediente(document.frminscribir.cedula_abogado_ejecutor.value,document.frminscribir.id_proactuacion.value,'Ejecutor');" value="Guardar" id="boton" name="boton">
                                                                                <input type="images" onmouseover="Tip('Cancelar Abogado Demandantes')" style="background-color:#B9D5E3;border:1px outset #B9D5E3;color:#004E7D;cursor:pointer;margin:1px;padding:1px; width:55px; font-size:11px;" onclick="javascript:$('contenedorAbogados').hide();$('id_tr_abogados_ejecutores').hide();$('contenedorAbogadosEjecutorExpediente').show();" value="Cancelar" id="boton" name="boton">
                                                                       </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="6">
                                                                    ...
                                                                    <tr>                                                              
                                                                        <td colspan="6">
                                                                            <div id="contenedorAbogadosEjecutorExpediente" style="display:none;" align="left">
                                                                                <div align="center"></div>
                                                                            </div>
                                                                        </td>
                                                                    </tr> -->        
...
<!--                                                                    <tr>
                                                                        <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                                                            <div align="left" style="background-image: url('../comunes/images/barra.png')">
                                                                                <strong>INFORMACIÓN COMPLEMENTARIA A LA DESCRIPCIÓN</strong>
                                                                                <img src="../comunes/images/application_form_add.png" onmouseover="Tip('Mas Información')" onmouseout="UnTip()" border="0" onclick="javascript:$('otros_datos_descripcion').toggle();"/>                                   
                                                                            </div>
                                                                        </td>
                                                                    </tr>                                                                        -->
                                                                </table>
<!--                                                                <table id="otros_datos_descripcion" style="display:none;" width="100%" border="0" class="tablaTitulo" >
                                                                    <tr>
                                                                        <td width="20%">
