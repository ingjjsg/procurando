        ...
        <script language="javascript">
            ...
            function eliminar_cliente(id_cliente){
                if(confirm("Desea eliminar este cliente")){
                    xajax_eliminar_cliente(id_cliente);
                }
            }
        </script>
    </head>
    <body onload="xajax_buscarDatosClientes()" >
        <script src="../comunes/js/wz_tooltip/wz_tooltip.js" type="text/javascript"></script>
        <center>
            <form name="frmclientes" id="frmclientes" method="post">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="65%" class="menu_izq_titulo">Solicitantes</td>
                    <td width="10%" align="center" class="menu_izq_titulo">
                        <?php 
                        if(clPermisoModelo::getVerificar_Accion(clConstantesModelo::getFormulario('clientes'),'nuevo', clConstantesModelo::acciones_clientes())) {?>
                        <img src="../comunes/images/user_add.png" onmouseover="Tip('Nuevo Solicitante')" onmouseout="UnTip()" onclick="location.href='vista_nuevo_cliente.php'"/>
                        &nbsp;&nbsp;&nbsp;
                        <?php }?>
