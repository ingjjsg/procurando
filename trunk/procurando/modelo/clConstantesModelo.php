...
// ACTUACIONES CAMPOS
    const CEDULASOLICITANTE='%CEDULA_SOLICITANTE';
    const NOMBRESOLICITANTE='%NOMBRE_SOLICITANTE';
    const NOMBREABOGADORESPONSABLE='%NOMBRE_ABOGADO_RESPONSABLE';
    const CEDULAABOGADORESPONSABLE='%CEDULA_ABOGADO_RESPONSABLE'; 
    const NOMBREABOGADOEJECUTOR='%NOMBRE_ABOGADO_EJECUTOR';    
    const CEDULAABOGADOEJECUTOR='%CEDULA_ABOGADO_EJECUTOR';    
...
// esquemas
  ...
  public static function ComboModulosLitigioFases() {return array('14028'=>'Recurso N°','13929'=>'Otras Fases');}      
  const bancos='12194';
...
//  const otras_fases_motivos_litigio=14028;    
  ...
  const anexa_actuacion_agenda='14062';      
	...
	const IdMaestroCategoriaDocumento = 19;//12422;
        ...
        public static function combos(){return array(
            ...
            'tipo_motivo_reasignacion' => '14105'              
        );
        }
