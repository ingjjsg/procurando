<?php
    ...
    $dataciudad = $correspondencia->buscarCiudad($dataCorrespondencia[0]['id_unidad_maestro']);
    ...
    for($i= 0; $i < count($dataDestinatario); $i++){
        if($dataDestinatario[$i]['nombre_tipoenvio_maestro'] == 'PR'){
            $strPR.= $dataDestinatario[$i]['trato_destinatario']."<br>".$dataDestinatario[$i]['nombre_destinatario']."<br>";
            $strPR.= $dataDestinatario[$i]['cargo_destinatario']."<br>".$dataDestinatario[$i]['institucion_destinatario'];
        }
    }
                    ...
                    <td>
                        <table width="100%" border="0" style="font-size:14px;font-family:arial" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <?if ($dataciudad[0]['ciudad']=="")
                                    	$ciudad = "Caracas";
                                      else
                                      	$ciudad = $dataciudad[0]['ciudad'];
                                    ?>
                                    <td colspan="3" bgcolor="#f8f8f8" align="right">
                                        <em><?= $ciudad.", ".$fechaEnvio; ?></em>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3" align="right" nowrap="true" style="font-size:12px;padding-top:5px">
