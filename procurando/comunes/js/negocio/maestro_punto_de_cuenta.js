 ...
 */
 ...
 function guardar_salto(){
  ...
  {
    alert('Seleccione un Cambio del Formulario Movimientos de Aprobación Punto de Cuenta para Guardar Cambio ')
  }
  else
  {
       if ((document.frmcontacto.strjustificacion.value == "") || (document.frmcontacto.id_razon.selectedIndex==0))
       {
         alert('Llene todo el Formulario Justificacion de Movimiento Aprobación Punto de Cuenta')
       }
       else
       {
        if (confirm('Â¿Seguro desea cambiar el estado de la Aprobación Punto de Cuenta?')){
 ...
 function actualizar_un_paso(acc,arreglo){
       $('justificacion').show();
       $('contenedor').show();
       if (acc=='R') msg='La Aprobación Punto de Cuenta Retrocedera un Estado';
       else msg='La Aprobación Punto de Cuenta Avanzara un Estado';
       alert(msg);
 ...
 function guardar_un_paso()
 {
       ...
       {
         alert('Llene todo el Formulario de Justificacion Movimiento de Aprobación Punto de Cuenta')
       }
       else
       {
            if (confirm('Â¿Seguro desea cambiar el estado de la Aprobación Punto de Cuenta?'))
 ...
 function actualizar_idproyecto_avanzar()
 {
      if (document.frmcontacto.id_avanzar.value != "")
      {
          ...
          alert('La Aprobación Punto de Cuenta Avanzara de Estado');
      }
 }
  ...
  function actualizar_idproyecto_retroceder()
 {
      if (document.frmcontacto.id_retroceder.value != "")
      {
          ...
          alert('La Aprobación Punto de Cuenta Retrocedera de Estado');
      }
 }
