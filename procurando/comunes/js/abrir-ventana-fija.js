function abrirVentanaFija(pagina, ancho, alto, nombre, titulo, botonCerrar) {
	...
	var src = '../comunes/images/ventana/';
    ...
    if(botonCerrar == true){
        html+= '<td ' + celdaImagen + '>'+cerrar+'</td>';
    }else{
        html+= '<td ' + celdaImagen + '></td>';
    }
	html+= '<td ' + superiorDerecha + '>&nbsp;</td>'
