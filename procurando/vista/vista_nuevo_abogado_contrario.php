...
//    else  $nombre_modulo='Abogado Contrario';
    ...
    if ($_SESSION['id_oficina']=='L') {
        ...
        $nombre_modulo='Abogado Contrario';
...
//    $xajax->registerFunction('llenarSelectSexo');
    ...
    $xajax->registerFunction('selectAbogadoContrario');
        ...
        <script language="javascript">
            ...
            function cargar(lngcodigo_abogado){
                if(lngcodigo_abogado != ""){
                    xajax_selectAbogadoContrario(lngcodigo_abogado);
                }else{
                    xajax_llenarSelectEstados('frmabogado_contrario_nuevo');
                }
            }
...
//            }
    ...
    <body onload="cargar('<?php echo $lngcodigo_abogado ?>')" >
        ...
        <center>
            <form name="frmabogado_contrario_nuevo" id="frmabogado_contrario_nuevo" method="post">
              <fieldset style="border:#339933 2px solid">                
                ...
                <tr>
                    ...
                    <td width="10%" align="center" class="menu_izq_titulo">
                        <?php 
                        if(clPermisoModelo::getVerificar_Accion(clConstantesModelo::getFormulario($formulario),'guardar', clConstantesModelo::$accion())) {?>
                        <img src="../comunes/images/16_save.png" onmouseover="Tip('Guardar')" onmouseout="UnTip()" border="0" onclick="<?php echo $funcion ?>(xajax.getFormValues('frmabogado_contrario_nuevo'));"/>
                        &nbsp;&nbsp;&nbsp;
                        <?php }?>
                        <img src="../comunes/images/arrow_undo.png" onmouseover="Tip('Volver')" onmouseout="UnTip()" border="0" onclick="location.href='vista_abogados_contrarios.php'"/>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    <td>
                        <div id="formulario" style=" width:100%;" align="left">
                                <input type="hidden" class='inputbox' id="id_abogadoscon" name="id_abogadoscon" size="30" />
                                    ...
                                    <tr>
                                        <td colspan="6" style="border:#CCCCCC solid 1px;" bgcolor="#F8F8F8" >
                                            <div align="center" style="background-image: url('../comunes/images/barra.png')">
                                                <strong>Datos del Abogado Contrario</strong>
                                            </div>
                                        </td>
                                    </tr>                                    
                                    <tr>
...
<!--                                        <td width="20%">
                                        ...
                                        <td width="30%">
                                            <input type="text" class='inputbox' id="strcodipostal" name="strcodipostal" size="30" />
                                        </td>
...
<!--                                    
                                    <tr>
                                       ...
                                       <td width="20%">
                                        ...
                                        <td width="30%">
                                           <textarea id="strcurriculum" rows="2" cols="45" name="strcurriculum"></textarea>
                                        </td>
                                    </tr>-->
