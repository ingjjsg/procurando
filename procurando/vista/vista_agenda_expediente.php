<?php
    ...
    $xajax->registerFunction('buscarDatosExpedientesAgenda');
    $xajax->registerFunction('selectAllExpedientesFiltroAgenda');
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script language="javascript">
            ...
            function filtrar(){
                ...
                xajax_selectAllExpedientesFiltroAgenda(1,cedula_cliente, cedula_abogado_responsable,cedula_abogado_ejecutor,strexpediente);
                verForm('formulario');
            }
    ...
    <body onload="xajax_buscarDatosExpedientesAgenda(1)" >
        <script src="../comunes/js/wz_tooltip/wz_tooltip.js" type="text/javascript"></script>
        <center>
            <form name="frmexpedientes" id="frmexpedientes" method="post">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="65%" class="menu_izq_titulo">Agenda Expedientes</td>
