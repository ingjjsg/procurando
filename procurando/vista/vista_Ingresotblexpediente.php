<?php
    ...
    $xajax= new xajax();
    $xajax->registerFunction('buscarExpedienteVista'); 
                        ...
                        <table width="100%" border="0" class="tablaTitulo" >
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    ...
                                    <?php } else { ?>
                                    <input type="text" onblur="xajax_buscarExpedienteVista(document.frminscribir.strnroexpediente.value)" class='inputbox82' id="strnroexpediente" name="strnroexpediente" size="20" />
                                    <?php } ?>
                                </td>
                                <td width="20%">
...
<!--                                                    <img src="../comunes/images/ico_18_127.gif" onmouseover="Tip('Buscar Abogado Responsable')" onmouseout="UnTip()" border="0" onclick="xajax_buscarAbogado(document.frminscribir.cedula_abogado_responsable.value,'responsable');"/>                                    -->
                                            ...
                                            <tr>
                                                ...
                                                <td width="30%">
                                                    <input type="text" class='inputbox82' id="strreferencia" name="strreferencia" size="30" />                                                         
                                                </td>
                                                <td width="20%">
                                                </td>
                                                <td width="30%">
