...
//                cargar(1);
    ...
    <body onload="xajax_selectAllHonorariosLitigio();xajax_llenarSelectTipoHonorario();xajax_llenarSelectTipoTramite();xajax_llenarSelectTipoAno();">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td width="10%" align="center" class="menu_izq_titulo">
                        ...
                        <img src="../comunes/images/page_add.png" onmouseover="Tip('Nuevo Honorario')" onmouseout="UnTip()" border="0" onclick="javascript:location.href='vista_IngresotblprohonorariosLitigio.php'"/>                        
                        <?php }?>
                    </td>
                </tr>
