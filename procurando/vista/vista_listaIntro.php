            ...
            <script src="../comunes/js/wz_tooltip/wz_tooltip.js" type="text/javascript"></script>
                ...
                <tr>
                    ...
                    <!--                        <img id="anteriorano" src="../comunes/images/b_firstpage.png"  border="0" onclick="fowar('ANY');xajax_selectAgendaMeses(document.frmAgenda.id_anterior.value);"/>
                                            &nbsp;&nbsp;&nbsp;                                            -->
                                            <img id="anterior" src="../comunes/images/b_firstpage.png"  border="0" onclick="xajax_selectAgendaMeses(document.frmAgenda.id_anterior.value);fowar('AN');"/>
                                            &nbsp;&nbsp;&nbsp;
                                            <img id="actual" src="../comunes/images/Type.png"  border="0" onclick="xajax_selectAgendaMeses(document.frmAgenda.id_actual.value);fowar('AC');"/>
                                            &nbsp;&nbsp;&nbsp;
                                            <img id="siguiente" src="../comunes/images/b_lastpage.png"  border="0" onclick="xajax_selectAgendaMeses(document.frmAgenda.id_siguiente.value);fowar('SI');"/>
                    <!--                        &nbsp;&nbsp;&nbsp;
