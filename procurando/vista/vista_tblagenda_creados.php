...
//    require_once "../controlador/tblproexpedienteControlador.php";    
    ...
    $xajax->registerFunction('ActualizarItemAgendaCreadas');    
...
//                cargar(1);
    ...
    <body onload="xajax_selectAllAgendaCreados();xajax_llenarSelectTipoAgenda('','',1);xajax_llenarSelectTipoEvento();xajax_selectAllDpto();xajax_llenarSelectTipoPrioridad();">
