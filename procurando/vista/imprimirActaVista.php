<?php
    ...
    $pdf->Cell(40, 5, "Autorizado por:", 'LTR', 0, 'L');
    $pdf->Cell(38, 5, "Entregado por:", 'LTR', 0, 'L');
    $pdf->Cell(38, 5, "Recibido por:", 'LTR', 0, 'L');
    $pdf->Cell(40, 5, "Salida Verificada por:", 'LTR', 0, 'L');
    $pdf->Cell(40, 5, "Entrega Verificada por:", 'LTR', 0, 'L');
    $pdf->Ln();
    $pdf->Cell(40, 5, "", 'LR', 0, 'L');
    $pdf->Cell(38, 5, "", 'LR', 0, 'L');
    $pdf->Cell(38, 5, "", 'LR', 0, 'L');
    $pdf->Cell(40, 5, "", 'LR', 0, 'L');
    $pdf->Cell(40, 5, "", 'LR', 0, 'L');
    $pdf->Ln();
    $pdf->Cell(40, 4, $dataGerente[0]['strnombre']." ".$dataGerente[0]['strapellido'], 'LR', 0, 'C');
    ...
    $pdf->Ln();
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(40, 4, $dataGerente[0]['nombre_cargo'], 'LR', 0, 'C');
    $pdf->Cell(38, 4, "", 'LR', 0, 'L');
    $pdf->Cell(38, 4, "", 'LR', 0, 'L');
    $pdf->Cell(40, 4, "Seguridad INDER", 'LR', 0, 'L');
    $pdf->Cell(40, 4, "Seguridad INDER", 'LR', 0, 'L');
    $pdf->Ln();
    $pdf->SetFont('Arial', '', 6);
    $pdf->Cell(40, 4, utf8_decode($dataGerente[0]['nombre_dpto']), 'LBR', 0, 'C');
    $pdf->SetFont('Arial', '', 8);
    $pdf->Cell(38, 4, "", 'LBR', 0, 'L');
    $pdf->Cell(38, 4, "", 'LBR', 0, 'L');
    $pdf->Cell(40, 4, "Fecha y Hora:", 'LBR', 0, 'L');
    $pdf->Cell(40, 4, "Fecha y Hora:", 'LBR', 5, 'L');
    $pdf->Ln(3);
