<?php
    ...
    $xajax= new xajax();
    $xajax->registerFunction('llenarSelectTipoHonorarioLitigio');
    $xajax->registerFunction('selectAllHonorariosLitigio');
    $xajax->registerFunction('selectFiltrosHonorarios');    
    $xajax->registerFunction('insertHonorariosLitigio');
    $xajax->registerFunction('selectHonorario');    
    $xajax->registerFunction('eliminarHonorario');   
    $xajax->registerFunction('llenarSelectTipoTramiteLitigio');    
...
//                xajax_llenarSelectTipoTramite('frminserthonorarios');
              ...
              {
                xajax_llenarSelectTipoHonorarioLitigio('frminserthonorarios');             
                xajax_llenarSelectTipoTramiteLitigio('frminserthonorarios');                   
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="10%" align="center" class="menu_izq_titulo">
                            <img id="save" name="save" src="../comunes/images/disk.png" onmouseover="Tip('Guardar Honorario')" onmouseout="UnTip()" border="0" onclick="xajax_insertHonorariosLitigio(xajax.getFormValues('frminserthonorarios'));"/>
