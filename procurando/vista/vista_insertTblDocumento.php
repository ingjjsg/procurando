                                ...
                                <table width="100%" border="0" class="tablaVer" >
                                   ...
                                   <tr>
                                    ...
                                    <tr id="CapaExpediente" style="display: none;">
                                        ...
                                        <td width="30%">
                                            <input type="text" class='inputbox82' id="strnroexpediente" name="strnroexpediente" size="20" onKeyDown="xajax_buscarExpedientePopup(document.frmDocumento.id_expediente.value);" onKeyUp="xajax_buscarExpedientePopup(document.frmDocumento.id_expediente.value);"/>                             
