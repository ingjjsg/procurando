...
//======================================FUNCION ACTUALIZAR===============================================
    ...
    public function SelectAllAbogadosContrariosFiltro($strnombre="",$strapellido="",$strcedula=""){
        ...
        if($strnombre != ""){
             $sql .= " AND upper(tbl_abogados_contrarios.strnombre) LIKE '%".strtoupper($strnombre)."%'";
         }
         if($strapellido != ""){
             $sql .= " AND upper(tbl_abogados_contrarios.strapellido) LIKE '%".strtoupper($strapellido)."%'";
         }
         if($strcedula != ""){
             $sql .= " AND tbl_abogados_contrarios.strcedula LIKE '%".strtoupper($strcedula)."%'";
         }
