...
//        exit($sql);
    ...
    public function selectAllHonorariosCargados(){
        $conn= new Conexion();
        $conn->abrirConexion();
        $sql.= "SELECT * FROM ".clConstantesModelo::correspondencia_table."vista_honorarios_cargados ";
        $conn->sql= $sql;
        $data= $conn->ejecutarSentencia(2);
        $conn->cerrarConexion();        
        return $data;
...
//        exit($sql);             
    ...
    public function selectAllHonorarios(){
        ...
        $sql.=" from ".clConstantesModelo::correspondencia_table."tblprohonorarios order by id_honorarios asc";
        $conn->sql= $sql;
        $data= $conn->ejecutarSentencia(2);
        $conn->cerrarConexion();        
        return $data;
